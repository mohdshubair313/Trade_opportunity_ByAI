...
@router.get("/api/v1/sectors/{sector}/market-data")
...
@router.get("/api/v1/sectors/{sector}/relative-strength")
@limiter.limit("30/minute")
...
@router.get("/api/v1/sectors/correlations")
...
@router.get("/api/v1/sectors/{sector}/news")
@limiter.limit("30/minute")
